  ...
  public void toSourceString() {
    ImmutableMap<String, String> inputs =
        ImmutableMap.<String, String>builder()
            .put("classValue", "baseprocessors.AnnotationValuesTest.InsideClassA.class")
            .put(
                "classValues",
                "{baseprocessors.AnnotationValuesTest.InsideClassA.class,"
                    + " baseprocessors.AnnotationValuesTest.InsideClassB.class}")
            .put(
                "genericClassValue",
                "baseprocessors.AnnotationValuesTest.GenericClass.class")
            .put(
                "insideAnnotationValue",
                "@baseprocessors.AnnotationValuesTest.InsideAnnotation(19)")
            .put(
                "insideAnnotationValues",
                "{@baseprocessors.AnnotationValuesTest.InsideAnnotation(20),"
                    + " @baseprocessors.AnnotationValuesTest.InsideAnnotation(21)}")
            .put("stringValue", "\"hello\"")
            .put("stringValues", "{\"it\\'s\", \"me\"}")
            .put("enumValue", "baseprocessors.AnnotationValuesTest.Foo.BAR")
            .put(
                "enumValues",
                "{baseprocessors.AnnotationValuesTest.Foo.BAZ,"
                    + " baseprocessors.AnnotationValuesTest.Foo.BAH}")
            .put("intValue", "5")
            .put("intValues", "{1, 2}")
            .put("longValue", "6L")
        ...
        .isEqualTo(
            inputs.entrySet().stream()
                ...
                .collect(
                    joining(
                        ", ",
                        "@baseprocessors.AnnotationValuesTest.MultiValueAnnotation(",
                        ")")));
  }
