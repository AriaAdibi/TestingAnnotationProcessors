...
//    this.elmUtils = processingEnv.getElementUtils();
...
//   */
//  abstract protected Iterable<? extends Step> steps();
//
//  /** An optional hook for logic to be executed at the beginning of each round. */
//  abstract protected void preRoundProcess(RoundEnvironment roundEnv);
//
//  /** An optional hook for logic to be executed at the end of each round. */
//  abstract protected void postRoundProcess(RoundEnvironment roundEnv);
//
...
//  } //TODO needed?
//
//  private ImmutableSet<TypeElement> getSupportedAnnotationTypeElements(Step step) { //TODO needed?
//    return step.annotations().stream()
//        .map(elmUtils::getTypeElement)
...
//      Optional<? extends Element> missingElement = missingElementName.getElement(elmUtils);
...
//      Optional<? extends Element> deferredElement = deferredElementName.getElement(elmUtils);
//      if (deferredElement.isPresent()) {
//        findAnnotatedElements( //It will add the element and its enclosed elements (excluding (inner) class and interface) if there is matching annotation
//            deferredElement.get(),
...
//    ImmutableSetMultimap.Builder<TypeElement, Element> deferredElements = ImmutableSetMultimap.builder();
//    for (ElementName elementName : annotatedElements) {
//      Optional<? extends Element> element = elementName.getElement(elmUtils);
...
//     */
//    Optional<? extends Element> getElement(Elements elmUtils) {
//      return Optional.fromNullable(
//          kind == Kind.PACKAGE_NAME
//              ? elmUtils.getPackageElement(name)
//              : elmUtils.getTypeElement(name));
//    }
//
//    @Override
